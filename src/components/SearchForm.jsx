...
export default function SearchForm({
  ...
  return (
    ...
    >
      ...
      {/* ═════════════════════════════════════════════════════════════════════ */}
      <div className="pt-4 border-t border-slate-800 flex flex-col gap-4 relative z-10">
        ...
        <div className="space-y-2 pt-3 border-t border-slate-800/60">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              🌐 Page Scrape
              <span className="block text-[9px] font-normal opacity-70 mt-0.5">Miễn phí · Trực tiếp</span>
            </button>
            <button
              type="button"
            ...
            >
              ⚡ Apify API
              <span className="block text-[9px] font-normal opacity-70 mt-0.5">Ổn định · Cần token</span>
            </button>
          </div>
          ...
          {metadataSource === 'apify' && (
            <div className="space-y-2 pt-1">
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="text-[10px] font-semibold text-slate-500 mb-1 block">Actor ID</label>
                  <input
                    type="text"
                    value={apifyActorId}
                    onChange={(e) => setApifyActorId(e.target.value)}
                    placeholder="GdWCkxBtKWOsKjdch"
                    className="w-full bg-slate-800/90 border border-slate-700 rounded-lg px-2.5 py-1.5 text-[11px] text-slate-200 placeholder-slate-600 focus:border-emerald-500/50 outline-none transition-all font-mono"
                  />
                </div>
                <div>
                  <label className="text-[10px] font-semibold text-slate-500 mb-1 block">API Token</label>
                  <input
                    type="password"
                    value={apifyToken}
                    onChange={(e) => setApifyToken(e.target.value)}
                    placeholder="apify_api_xxx..."
                    className="w-full bg-slate-800/90 border border-slate-700 rounded-lg px-2.5 py-1.5 text-[11px] text-slate-200 placeholder-slate-600 focus:border-emerald-500/50 outline-none transition-all"
                  />
                </div>
              </div>
              <p className="text-[9px] text-slate-600">
                Lấy tại{' '}
                <a href="https://console.apify.com" target="_blank" rel="noopener noreferrer" className="text-emerald-500 hover:underline">
                  console.apify.com
                </a>
                {' '}· Free $5/tháng
              </p>
